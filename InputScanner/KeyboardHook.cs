...
namespace InputScanner
{
    ...
    public class KeyboardHook
    {
        ...
        private WindowsHookHandler hookHandler;
        ...
        private IntPtr SetHook(WindowsHookHandler proc)
        {
            using (ProcessModule module = Process.GetCurrentProcess().MainModule)
                return User32.SetWindowsHookEx(13, proc, User32.GetModuleHandle(module.ModuleName), 0);
        }
        ...
        private IntPtr HookFunc(int nCode, IntPtr wParam, IntPtr lParam)
        {
            if (nCode >= 0)
            {
                ...
                if ((iwParam == User32.WM_KEYDOWN || iwParam == User32.WM_SYSKEYDOWN))
                    KeyDown?.Invoke((VKeys)Marshal.ReadInt32(lParam));
                if ((iwParam == User32.WM_KEYUP || iwParam == User32.WM_SYSKEYUP))
